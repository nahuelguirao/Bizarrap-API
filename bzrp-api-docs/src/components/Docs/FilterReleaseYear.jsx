    ...
    return (
        <main className="docsMain">
            ...
            <div className="urlContainer">
                ...
                <p>URL <span className="urlLink">https://bizarrap-api.up.railway.app/sessions/freestyle<span className="redSpan">?year=2019</span></span></p>
            </div>
            <div className="urlContainer">
                <h4>Music session example</h4>
                <p>URL <span className="urlLink">https://bizarrap-api.up.railway.app/sessions/music<span className="redSpan">?year=2023</span></span></p>
            </div>
