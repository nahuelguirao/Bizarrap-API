    ...
    return (
        <main className="docsMain">
            ...
            <div className="urlContainer">
                ...
                <p>URL <span className="urlLink">https://bizarrap-api-production.up.railway.app/sessions/freestyle<span className="redSpan">?shot=@GianGuaglianone</span></span></p>
            </div>
            <div className="urlContainer">
                <h4>Music session example</h4>
                <p>URL <span className="urlLink">https://bizarrap-api-production.up.railway.app/sessions/music<span className="redSpan">?shot=@pedro.colmeiro</span></span></p>
            </div>
