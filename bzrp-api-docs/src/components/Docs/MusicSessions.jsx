    ...
    return (
        <main className="docsMain">
            ...
            <div className="urlContainer">
                <p>URL <span className="urlLink">https://bizarrap-api.vercel.app/sessions/music</span></p>
            </div>
            <h3 className="marginTop50px">
            ...
            <div className="urlContainer">
                <p>URL <span className="urlLink">https://bizarrap-api.vercel.app/sessions/music/<span className="redSpan">$sessionNumber</span></span></p>
            </div>
